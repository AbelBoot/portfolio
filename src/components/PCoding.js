...
export const PCoding = () => {
	...
	return(
                <PCoContainer >
				<PCODIV1>
				{locale === "en" && <><H5>Here are some of my programming skills. Over the last few years, I have been learning to use a number of tools and frameworks in my free time. Below, are some of the technologies I used the most. Currently, I am mostly focusing on C#, JavaScript and React.</H5><H5>This webpage has been fully done in React. The repository for this website and my other works are available at the links below.</H5></>}
				{locale === "fr" && <><H5>Voici quelques-unes de mes compétences en programmation. Au cours des ces dernières années, j'ai appris à utiliser un certain nombre d’outils et de frameworks, pendant mon temps libre. Ci-dessous, quelques-uns de ceux que j'ai le plus utilisés. Actuellement, je me concentre principalement sur C#, JavaScript et React.</H5><H5>Cette page Web a été entièrement réalisée avec React. Le dépôt de ce site Web, et ceux de mes autres projets, peuvent être consultés en cliquant sur les liens ci-dessous.</H5></>}
				{locale === "sp" && <><H5>Estas son algunas de las cosas que sé hacer en programación. Durante estos últimos años, he aprendido a utilizar una serie de herramientas y frameworks en mi tiempo libre. Actualmente, estoy trabajando principalmente con C#, JavaScript y React.</H5><H5>Esta página web se ha realizado completamente en React. El repositorio de este sitio web, y algunos de mis otros trabajos están disponibles en los enlaces a continuación.</H5></>}
				{locale === "pt" && <><H5>Aqui há algumas das minhas habilidades de programação. Nos últimos anos, aprendí vários tools e frameworks, no meu tempo livre. Abaixo, há algumas das tecnologias que mais usei. Atualmente, estou focando principalmente em C#, JavaScript e React.</H5><H5>Esta página web foi totalmente elaborada em React. O repositório deste site e meus outros trabalhos encontram-se nos links abaixo.</H5></>}
				</PCODIV1>
				<PCODIV2_00>
				<PCODIV2_01>
				<PCODIV2_01_1>
